...
| Arduino Uno 1 | `sketches/uno_gate_no_lcd_test/uno_gate_no_lcd_test.ino` | LCD 제외, 조도센서와 서보만 테스트 |
| Arduino Uno 1 | `sketches/uno_i2c_scanner/uno_i2c_scanner.ino` | LCD I2C 주소와 배선 확인 |
