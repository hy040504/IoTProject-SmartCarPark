...
프로젝트 루트의 [시연 자료](<시연 자료>) 폴더에 실제 시연 사진, 관리자 페이지 화면, LCD 동작 영상, 제작 과정 사진을 정리해 두었습니다.

### 폴더 구성

| 폴더 | 내용 |
| --- | --- |
| [시연 자료/사진](<시연 자료/사진>) | 완성된 모형 사진, 관리자 페이지 캡처, 추가 화면 스크린샷 |
| [시연 자료/영상](<시연 자료/영상>) | 전체 동작, LCD, 관리자 페이지, 모형 시연 영상 |
| [시연 자료/제작 과정 사진](<시연 자료/제작 과정 사진>) | 브레드보드 배선과 조립 과정 사진 |
| [Iot 스마트 주차장 (연승현, 장기환).pptx](<시연 자료/Iot 스마트 주차장 (연승현, 장기환).pptx>) | 프로젝트 발표용 PPT 자료 |

### 발표자료

[Iot 스마트 주차장 (연승현, 장기환).pptx](<시연 자료/Iot 스마트 주차장 (연승현, 장기환).pptx>)는 프로젝트 발표용 자료입니다. 슬라이드 텍스트가 이미지형으로 구성되어 있어 문장 단위 추출은 하지 않았고, 현재 프로젝트 기준으로 아래 내용을 중심으로 정리된 발표 자료로 안내합니다.

- 프로젝트 개요와 제작 목적
- Arduino Uno 1, Uno 2, Uno 3, Node.js 서버의 역할 분담
- 입차 감지, 주차칸 감지, 출차 확정, 요금 계산 흐름
- 관리자 페이지 실시간 모니터링 화면
- 실제 시연 사진과 동작 장면 정리
...
| 자료 | 설명 |
| --- | --- |
| [전체장면.mp4](<시연 자료/영상/전체장면.mp4>) | 전체 스마트 주차장 시연 장면 |
| [모형.mp4](<시연 자료/영상/모형.mp4>) | 주차장 모형과 센서 배치 중심 영상 |
| [LCD 모니터.mp4](<시연 자료/영상/LCD 모니터.mp4>) | 출구 LCD 표시 화면 중심 영상 |
| [관리자 페이지.mp4](<시연 자료/영상/관리자 페이지.mp4>) | 관리자 페이지 실시간 모니터링 영상 |
| [전체 시연 영상.txt](<시연 자료/영상/전체 시연 영상.txt>) | 전체 시연 영상 관련 메모 파일 |

### 사진 미리보기

완성 사진과 관리자 페이지 캡처는 README에서 바로 확인할 수 있도록 미리보기를 추가했습니다.
